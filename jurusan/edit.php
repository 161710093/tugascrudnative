...
<html lang="en">
  ...
  ?>
	<center><h1 style="color: violet"><font face="algerian">Edit Data Jurusan</font></h1></center>
	<fieldset style="width: 50%;margin: auto;">
	<legend style="color: violet"><font face="algerian">Form Edit Data Jurusan</font></legend>
	<form action="simpanedit.php" method="post">
	<input type="hidden" name="id" value="<?php echo $data['id'];?>">
	<p>
	<font face="algerian" style="color: violet">
		Jurusan : <br/> </font>
		<font face="lucida calligraphy"><input type="text" name="jurusan" class="form-control" value="<?php echo $data['jurusan']; ?>" required>
	</font>
	</p>
	<p>
...
<br>
<center><a class="btn btn-primary" href="lihatdatajurusan.php" role="button"> << Tabel Jurusan</a></center>
