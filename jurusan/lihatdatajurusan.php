...
<center>
<h1 style="color: violet"> <font face="algerian">Data Jurusan</font></h1>
<table class="table table-bordered ">
  <th bgcolor="magenta" style="color: white" ><font face="algerian"><center>Nomor</center></font></th>
  <th bgcolor="magenta" style="color: white"><font face="algerian"><center>Jurusan</center></font></th>
  ...
  foreach ($ma as $data) {
    ...
    <td><center><a class='btn btn-success' href = 'show.php?id=$data[id]'>Show </a>
      </center></td>
    <td><center><a class='btn btn-warning' href = 'edit.php?id=$data[id]'>Edit </a>
      </center></td>
    <td><center><a class='btn btn-danger' href = 'delete.php?id=$data[id]'> Delete </a>
      </center></td>
    </tr>";
    $no++;
  }
...
<br> 
<center>
<a class="btn btn-primary" href="tambah.php" role="button">+ Tambah Data Jurusan</a>
</center>
