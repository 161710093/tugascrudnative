...
<html lang="en">
  ...
  <li><a href="profil.php"><img src="annisa.jpg" height="30px">Profile</a></li>
    ...
    <center>
    <h1 style="color: violet"><font face="algerian">Data Kelas</font></h1>
    ...
    <th bgcolor="magenta" style="color: white"><font face="algerian"><center>Wali Kelas</center></font></th>
  ...
  foreach ($ma as $data) {
    echo "<tr bgcolor=white>
     ...
     <td><center>".$data['nama_jurusan']."</center></td>
     <td><center>".$data['wali_kelas']."</center></td>
...
<br>
<center>
<a class="btn btn-primary" href="tambah.php" role="button">+ Tambah Data Kelas</a></center>
