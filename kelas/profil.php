...
<html lang="en">
  ...
  <li><a class="profil.php" href="profil.php"><img src="annisa.jpg" height="30px">Profile</a></li>
  </ul>
</ul>
</nav>
  </div>
  ...
  <h1>Biodata</h1>
  <img src="nisa.jpg" height="150px" width="170px" class="img-rounded">
  <br>
  <br>
  <h3>
  <table>
  <tr>
    <td>Nama Lengkap</td>
    <td>:</td>
    <td>Annisa.Hafitria</td>
  </tr>
  <tr>
    <td>Nama Panggilan</td>
    <td>:</td>
    <td>Annisa,Nisa,Cica,Icha,ChaCha</td>
  </tr>
  <tr>
    <td>Tempat Tanggal Lahir </td>
    <td>:</td>
    <td>Bandung,27 Februari 2002</td>
  </tr>
   <tr>
    <td>Cita-Cita </td>
    <td>:</td>
