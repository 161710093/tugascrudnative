...
<html lang="en">
 ...
 <ul class="nav navbar-nav navbar-right">
  ...
  <h1 align="center" style="color: magenta"><font face="algerian"> Input Data Kelas </font></h1>
<fieldset style="width: 50%; margin: auto;">
<legend style="color: magenta"><font face="algerian">Form Input Data Kelas</font></legend>
<form action="simpan.php" method="post">
  ...
  <font face="algerian" style="color: violet">
    Wali Kelas : <br /></font>
    <font face="lucida calligraphy"><input type="text" name="wali_kelas" class="form-control" placeholder="wali kelas" required></font>
    </p>
  <p>
...
<br/>
<center><a class="btn btn-primary" href="lihatdatakelas.php" role="button"><< Tabel Kelas</a></center>
